  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "min-h-10 rounded-md border border-input text-sm ring-offset-background focus-within:ring-1 focus-within:ring-offset-1 focus-within:ring-neutral-300",
            {
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="absolute top-2 z-10 max-h-35 w-full rounded-md border text-popover-foreground shadow-md outline-none animate-in bg-neutral-900/90 backdrop-blur-sm [&::-webkit-scrollbar]:hidden border-none"
              onMouseLeave={() => {
